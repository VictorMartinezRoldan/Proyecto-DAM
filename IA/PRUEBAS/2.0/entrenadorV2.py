...
modelo = tf.keras.Sequential([
    ...
    layers.Dense(num_clases, activation='sigmoid') # Neuronas == Num de clases a clasificar
])
...
callbacks = [
    ...
    ModelCheckpoint('IA-Banderas.keras', save_best_only=True)
]
# -----------------------------------------------------------------
# Entrenar el modelo
print("Comenzando el entrenamiento...")
modelo.fit(train_generator, validation_data=val_generator, epochs=EPOCHS, callbacks=callbacks)

print("Entrenamiento completado. Modelo guardado como 'IA-Banderas.keras'.")